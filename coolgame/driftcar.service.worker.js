...
/** @type {string} */
const CACHE_VERSION = '1776753054|1081479311';
/** @type {string} */
const CACHE_PREFIX = 'некий проект-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'driftcar.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["driftcar.html","driftcar.js","driftcar.offline.html","driftcar.icon.png","driftcar.apple-touch-icon.png","driftcar.audio.worklet.js","driftcar.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["driftcar.wasm","driftcar.pck"];
