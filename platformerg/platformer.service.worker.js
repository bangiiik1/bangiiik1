...
/** @type {string} */
const CACHE_VERSION = '1784457554|64985227403';
/** @type {string} */
const CACHE_PREFIX = 'platformer-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'platformer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["platformer.html","platformer.js","platformer.offline.html","platformer.icon.png","platformer.apple-touch-icon.png","platformer.audio.worklet.js","platformer.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["platformer.wasm","platformer.pck"];
